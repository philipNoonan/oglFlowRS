...
{
	m_texturePreviousColour = GLHelper::createTexture(m_texturePreviousColour, GL_TEXTURE_2D, 1, m_color_width, m_color_height, 0, GL_RGBA8, GL_LINEAR, GL_LINEAR_MIPMAP_NEAREST);
...
void gRender::setTextures(GLuint depthTex, GLuint colorTex, GLuint edgesTex, GLuint fmmfTex)
{
